...
.DESCRIPTION
    ...
    её и меряет: инструмент говорит "дорога жива, называть сейчас нечего" там, где карта
    транзакций не наполнялась вовсе. Это ровно то утешительное враньё, ради которого
    перекрёстная проверка и написана.
