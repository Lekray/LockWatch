...
.DESCRIPTION
    Прогонов одиннадцать, и до сих пор порядок их и предусловия жили в голове того, кто
    их писал. Это ровно тот вид знания, который теряется первым, а потеря его дорога:
