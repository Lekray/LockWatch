...
-- Пустое имя таблицы - не «ресурс не разобрался», а невидимый каталог. Отличить одно от
-- другого человек не может ничем, кроме этих слов: очередь на экране, длительности верны,
